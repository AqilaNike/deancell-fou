...
<div class="bg-white rounded-lg shadow-sm border-t-4 border-blue-500 max-w-3xl">
    <div class="p-4 border-b border-gray-200">
        <h3 class="text-lg font-medium text-gray-800">Form Tambah Produk</h3>
    </div>
        ...
        <form action="{{ route('produk.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="namaProduk" id="namaProduk" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('namaProduk') }}" required>
                    @error('namaProduk')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="harga_beli" id="harga_beli" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('harga_beli') }}">
                    @error('harga_beli')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-4">
                    ...
                    <input type="number" name="harga_jual" id="harga_jual" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('harga_jual') }}">
                    @error('harga_jual')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="stok" id="stok" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('stok') }}">
                    @error('stok')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4 md:col-span-2">
                    ...
                    <select name="jenisProduk" id="jenisProduk" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" required onchange="toggleFields()">
                        ...
                        <option value="Handphone" {{ old('jenisProduk') == 'Handphone' ? 'selected' : '' }}>Handphone (HP)</option>
                        <option value="Provider" {{ old('jenisProduk') == 'Provider' ? 'selected' : '' }}>Provider / Kuota / Pulsa</option>
                        <option value="BRILink" {{ old('jenisProduk') == 'BRILink' ? 'selected' : '' }}>Layanan BRILink</option>
                        <option value="Aksesoris" {{ old('jenisProduk') == 'Aksesoris' ? 'selected' : '' }}>Aksesoris / Lainnya</option>
                    </select>
                    @error('jenisProduk')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
            ...
            <div id="hp_fields" class="mt-4 p-4 bg-gray-50 rounded border hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <input type="text" name="merk" id="merk" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('merk') }}">
                    </div>
                    <div class="mb-4">
                        <label for="warna" class="block text-sm font-medium text-gray-700 mb-1">Warna</label>
                        <input type="text" name="warna" id="warna" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('warna') }}">
                    </div>
                    <div class="mb-4">
                        <label for="imei_sn" class="block text-sm font-medium text-gray-700 mb-1">IMEI / SN</label>
                        <input type="text" name="imei_sn" id="imei_sn" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('imei_sn') }}">
                    </div>
                    <div class="mb-4">
            ...
            <div id="provider_fields" class="mt-4 p-4 bg-green-50 rounded border hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="masa_aktif" id="masa_aktif" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('masa_aktif') }}" placeholder="Contoh: 30">
                    </div>
                    <div class="mb-4">
                        <label for="imei_sn2" class="block text-sm font-medium text-gray-700 mb-1">Serial Number (SN)</label>
                        <input type="text" name="imei_sn_provider" id="imei_sn2" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('imei_sn') }}">
                    </div>
                </div>
            </div>
            ...
            <div id="brilink_fields" class="mt-4 p-4 bg-blue-50 rounded border hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <input type="number" name="biaya_admin" id="biaya_admin" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('biaya_admin') }}">
                    </div>
                    <div class="mb-4">
                        <label for="tipe_layanan" class="block text-sm font-medium text-gray-700 mb-1">Tipe Layanan</label>
                        <input type="text" name="tipe_layanan" id="tipe_layanan" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="{{ old('tipe_layanan') }}" placeholder="Contoh: Tarik Tunai">
                    </div>
                </div>
            </div>
